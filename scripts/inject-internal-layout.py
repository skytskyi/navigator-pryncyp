...
CSS_TAG = '<link rel="stylesheet" href="/css/internal-layout.css?v=141"/>'
CRITICAL_BLOCK = (
...
JS_TAG = '<script src="/js/internal-layout.js?v=77"></script>'
...
def main() -> None:
    ...
    for path in sorted(ROOT.rglob("*.html")):
        ...
        new_text = re.sub(
            ...
            'href="/css/internal-layout.css?v=141"',
            text,
        )
        if new_text != text:
            text = new_text
        ...
        new_text = re.sub(
            ...
            'src="/js/internal-layout.js?v=77"',
            text,
        )
        if new_text != text:
            text = new_text
